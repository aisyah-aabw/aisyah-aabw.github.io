...
<title>SIA-IPB &mdash; Worksheet</title>
<?= $this->endsection() ?>
...
<section class="section">
    <div class="section-header">
        <h1>Laporan Worksheet</h1>
    </div>
    <!-- ini untuk menangkap session success dengan bawaan with -->

    <div class="section-body">
        <div class="card-body">
            <form action="<?= site_url('neracalajur') ?>" method="GET">
                <?= csrf_field() ?>
                <div class="row g-3">
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <input type="submit" class="btn btn-danger" formtarget="_blank" formaction="neracalajur/neracalajurpdf" value="Cetak pdf">
                    </div>
                </div>
            </form>
        </div>
                ...
                <table class="table table-striped table-md">
                    <thead class="judul">
                        <tr>
                            ...
                            <td class="text-center" colspan="2">Neraca Saldo Penyesuaian </td>
                            <td class="text-center" colspan="2">Laba Rugi </td>
                            <td class="text-center" colspan="2">Posisi Keuangan </td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($dttransaksi as $key => $value) : ?>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?= number_format($lpkd, 0, ",", ",") ?></td>
                                <td class="text-right"><?= number_format($lpkk, 0, ",", ",") ?></td>
                            </tr>
