...
<title>SIA IPB &mdash; Akun3</title>
<?= $this->endSection() ?>
                            ...
                            <?php foreach ($dtakun3 as $key => $value) : ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="width:15%">
                                        <a href="<?= site_url('akun3/' . $value->id_akun3) . '/edit' ?>" class="btn btn-warning">
                                        ...
                                        <form action="<?= site_url('akun3/' . $value->id_akun3) ?>" method="post" id="del-<?= $value->id_akun3 ?>" class="d-inline">
                                            ...
                                            <button type="button" class="btn btn-danger btn-small" onclick="hapus(<?= $value->id_akun3 ?>)">
