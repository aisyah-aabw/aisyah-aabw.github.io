                        ...
                        <tbody>
                            <?php foreach ($dtpenyesuaian as $key => $value) : ?>
                                <tr>
                                    ...
                                    <td><?= number_format($value->nilai, 0, ',', '.'); ?></td>
                                    <td><?= $value->waktu ?></td>
                                    ...
                                    <td class="text-center" style="width:20%">
                                        ...
                                        <a href="<?= site_url('penyesuaian/' . $value->id_penyesuaian) . '/edit' ?>" class="btn btn-warning">
                                        ...
                                        <form action="<?= site_url('penyesuaian/' . $value->id_penyesuaian) ?>" method="post" id="del-<?= $value->id_penyesuaian ?>" class="d-inline">
                                            ...
                                            <button type="button" class="btn btn-danger btn-small" onclick="hapus(<?= $value->id_penyesuaian ?>)">
