 ...
 <li class="nav-item dropdown">
     <a href="#" class="nav-link has-dropdown"><i class="fas fa-bars"></i><span>Kode Akun</span></a>
 ...
 <li class="#"><a class="nav-link" href="<?= site_url('jurnalumum') ?>"><i class="fas fa-pen-fancy"></i><span>Jurnal Umum</span></a></li>
 <li class="#"><a class="nav-link" href="<?= site_url('posting') ?>"><i class="fas fa-copy"></i><span>Posting</span></a></li>
 <li class="#"><a class="nav-link" href="<?= site_url('neracasaldo') ?>"><i class="fas fa-balance-scale"></i><span>Neraca Saldo</span></a></li>
 <li class="#"><a class="nav-link" href="<?= site_url('neracalajur') ?>"><i class="fas fa-square"></i><span>Neraca Lajur</span></a></li>
