...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/template/node_modules/database.net-bs4/css/dataTables.bootstrap4.min.css">
        ...
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src="<?= base_url('imgFiles/' . user()->gbr) ?>" class="rounded-circle mr-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <?php } else { ?>
                                <a href="/login" class="dropdown-item has-icon text-danger"><i class="fas fa-sign-in-alt"></i> Login </a>
                            <?php } ?>
                        </div>
                    </li>
                </ul>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2025 <div class="bullet"></div> Design By <a href="https://nauval.in/">Aisyah Arifin</a>
                </div>
