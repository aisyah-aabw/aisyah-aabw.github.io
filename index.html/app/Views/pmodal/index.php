...
<title>SIA-IPB — Perubahan Modal</title>
                ...
                <table class="table table-striped table-md">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="text-right" style="padding-right:6em"><?= number_format($dttransaksi['labarugi'], 0, ",", ","); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="text-left">Perubahan Modal</td>
                            <td></td>
