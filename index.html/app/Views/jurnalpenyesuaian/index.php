...
<section class="section">
    ...
    <div class="section-body">
        <div class="card-body">
            <form action="<?= site_url('jurnalpenyesuaian') ?>" method="GET">
                <?= csrf_field() ?>
                <div class="row g-3">
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <input type="submit" class="btn btn-danger" formtarget="_blank" formaction="jurnalpenyesuaian/cetakjppdf" value="Cetak pdf">
                    </div>
                </div>
            </form>
        </div>
